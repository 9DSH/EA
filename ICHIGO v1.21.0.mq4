...
int gTkLineBearish, gKjLineBearish, gChLineBearish , gTkLineBullish , gKjLineBullish , gChLineBullish, gBullishKomu ,
    gBearishKomu,gTkExitTime,gKjExitTime, gClosedOrder,gModifiedOrder, gNewStart, gPARemove = 0;
...
string gUserpointCSV,gEmotionalCSV, gStopLossCSV, gTakeProfitCSV, gSignalsCSV, gPriceActionCSV , gAdditionalPACSV, gStrongPACSV;
...
void FileCreation(string symbol)
   {
      gUserpointCSV = ""; gEmotionalCSV = ""; gStopLossCSV = ""; gTakeProfitCSV = ""; gSignalsCSV = ""; gPriceActionCSV = "";
...
//+-----------------------------------------------------------------------+ 
void Record_PriceAction(string Filename, string Mode, int Index, double PriceAction)
   {
      string Price;
      if(PriceAction == 0) Price = "       ";
      else Price =  DoubleToString(PriceAction,_Digits);
      ...
      if(Mode == "Append")      {uint res = AppendToFile(Filename,0,Data);}
      else if(Mode == "Modify") {uint res = AppendToFile(Filename,-9*Index,Data);}  
            ...
            if(gBearCrossStrong == 1)
              {
                  ...
                  Alert("Bearish Cross Failed -- Bullish CrossOver | You Can Wait for Kijunsen to Hit Greater Value");
                  Comment(RightBarTime,Message);
              }
            else
              {
                  ...
                  Alert("Strong Bullish CrossOver | You Can Wait for Kijunsen to Hit Greater Value");
                  Comment(RightBarTime,Message);
              }
            ...
            if(gBullCrossStrong == 1 )
              {
                  ...
                  Alert("Bullish Cross Failed -- Bearish CrossOver | You Can Wait for Kijunsen to Hit Lower Value");
                  Comment(RightBarTime,Message);
              }
            else
              {
                  ...
                  Alert("Strong Bearish CrossOver | You Can Wait for Kijunsen to Hit Lower Value");
                  Comment(RightBarTime,Message);
              }
            ...
            if(gBearCrossStrong == 1)
              {
                  ...
                  Alert("Bearish Cross Failed -- Bullish Road CrossOver | You Can Wait for Kijunsen to Hit Greater Value");
                  Comment(RightBarTime,Message);
              }
            else
              {
                  ...
                  Alert("Strong Bullish Road CrossOver | You Can Wait for Kijunsen to Hit Greater Value");
                  Comment(RightBarTime,Message);
              }
            ...
            if(gBullCrossStrong == 1)
              {
                  ...
                  Alert("Bullish Cross Failed -- Bearish Road CrossOver | You Can Wait for Kijunsen to Hit Lower value");
                  Comment(RightBarTime,Message);
              }
            else
              {
                  ...
                  Alert("Strong Bearish Road CrossOver | You Can Wait for Kijunsen to Hit Lower value");
                  Comment(RightBarTime,Message);
              }
                           ...
                           if(Komu_Situation(Shift) == "KomuZone")
                             {
                                 ...
                                 Comment(RightBarTime,Message); 
                                 Alert("KOMU Situation -- Candles Are Inside The Komu, Recommendations: "  ,"\r\n" , " > Waiting for candels to validly break from komu. "
                        ...
                        if((BuyConfirmation(Shift) == True))
                          {
                              ...
                              Alert("BULLISH CROSSOVER -- Bulls In Control"); 
                              Comment(RightBarTime,Message);
                          }    
                        else
                          {
                              ...
                              Alert("KOMU LIMITATION -- Opening Position is not Recommended, Wait for Candles to Break Komu Resistance Validly");
                          ...
                          if((SellConfirmation(Shift) == True))
                             {
                                 ...
                                 Alert("BEARISH CROSSOVER -- Bears In Control");
                                 Comment(RightBarTime,Message);
                             }
                           else
                             {
      ...
      if(KijunSen_new > KijunSen_previous)
        {
            ...
            if((Divergence(Shift-1) <= 100))
               ...
               {    
                     ...
                     Alert("Opening Position is not Recommended, There Are Divergences Between the Lines."); 
                     Comment(RightBarTime,Message);
               }
      ...
      if(gBullSpanB != 0)
        {
            ...
            if(Break_Validation("BEARISH",Resistance_B) == True)
                  ...
                  if(is_PrevCandle_Touch_Resistance(3,"BEARISH",Resistance_B) == False)
                     {
                           ...
                           Alert("BULLISH Komu Resistance (SenkouSpan B) Broken by Valid Candle, And Next Candle Didn't Pull Back to Komu.");
                           Comment(RightBarTime,Message);
                     }
                  else
                    {
                           string Message ="\n" + ">  Status: UNCURTAIN BREAKEVEN -- BULLISH KOMU BREAK.";
                           Alert("BULLISH Komu Resistance (SenkouSpan B) Broken by Valid Candle, And Next Candle Didn't Pull Back to Komu. But Former Candle Touched The SenkouSpan B. ");
                           Comment(RightBarTime,Message);
                    }
            ...
            else
              {
                  ...
                  Alert("BULLISH Komu Resistance (SenkouSpan B) Broken by Valid Candle, BUT Next Candle Pulled Back to Komu." ,"\r\n" , "You Should Wait For Valid Break.." );
                  Comment(RightBarTime,Message);
              }
        }
      if(gBearSpanA != 0)
        {
            ...
            if(Break_Validation("BEARISH",Resistance_A) == True)
                  ...
                  if(is_PrevCandle_Touch_Resistance(3,"BEARISH",Resistance_A) == False)
                    {
                        ...
                        Alert("BEARISH Komu Resistance (SenkouSpan A) Broken by Valid Candle, And Next Candle Didn't Pull Back to Komu.");
                        Comment(RightBarTime,Message);
                    }
                  else
                    {
                        string Message ="\n" + ">  Status: UNCURTAIN BREAKEVEN -- BEARISH KOMU BREAK.";
                        Alert("BEARISH Komu Resistance (SenkouSpan A) Broken by Valid Candle, And Next Candle Didn't Pull Back to Komu.  But Former Candle Touched The SenkouSpan A.");
                        Comment(RightBarTime,Message);
                    }
            ...
            else
              {
                  ...
                  Alert("BEARISH Komu Resistance (SenkouSpan A) Broken by Valid Candle, BUT Next Candle Pulled Back to Komu." ,"\r\n" , "You Should Wait For Valid Break.." );
                  Comment(RightBarTime,Message);
              }
        }
            ...
            if(Break_Validation("BULLISH",Resistance_B) == True)
              {
                   if(is_PrevCandle_Touch_Resistance(3,"BULLISH",Resistance_B) == False)
                     {
                            string Message ="\n" + ">  Status: BREAKEVEN -- BEARISH KOMU BREAK.";
                            Alert("BEARISH Komu Resistance (SenkouSpan B) Broken by Valid Candle, And Next Candle Didn't Pull Back to Komu.");
                            Comment(RightBarTime,Message);
                     }
                   else
                     {
                            string Message ="\n" + ">  Status: UNCURTAIN BREAKEVEN -- BEARISH KOMU BREAK.";
                            Alert("BEARISH Komu Resistance (SenkouSpan B) Broken by Valid Candle, And Next Candle Didn't Pull Back to Komu. But Former Candle Touched The SenkouSpan A.");
                            Comment(RightBarTime,Message);
                     }
              ...
              {
                   string Message ="\n" +  ">  Status: INVALID BREAKEVEN -- BEARISH KOMU BREAK.";
                   Alert("BEARISH Komu Resistance (SenkouSpan B) Broken by Valid Candle, BUT Next Candle Pulled Back to Komu." ,"\r\n" , "You Should Wait For Valid Break.." );
                   Comment(RightBarTime,Message);
              }
        }
      ...
      if(gBullSpanA != 0)
        {
            ...
            if(Break_Validation("BULLISH",Resistance_A) == True)
                   ...
                   if(is_PrevCandle_Touch_Resistance(3,"BULLISH",Resistance_A) == False)
                     {
                            ...
                            string Message ="\n" + ">  Status: BREAKEVEN -- BULLISH KOMU BREAK.";
                            Alert("BULLISH Komu Resistance (SenkouSpan A) Broken by Valid Candle, And Next Candle Didn't Pull Back to Komu.");
                            Comment(RightBarTime,Message);
                     }
                   else
                     {
                            string Message ="\n" + ">  Status: UNCURTAIN BREAKEVEN -- BULLISH KOMU BREAK.";
                            Alert("BULLISH Komu Resistance (SenkouSpan A) Broken by Valid Candle, And Next Candle Didn't Pull Back to Komu. But Former Candle Touched The SenkouSpan A.");
                            Comment(RightBarTime,Message);
                     }
              ...
              {
                   string Message ="\n" +  ">  Status: INVALID BREAKEVEN -- BULLISH KOMU BREAK.";
                   Alert("BULLISH Komu Resistance (SenkouSpan A) Broken by Valid Candle, BUT Next Candle Pulled Back to Komu." ,"\r\n" , "You Should Wait For Valid Break.." );
                   Comment(RightBarTime,Message);
              }
        }
   }
       ...
       if(gHistory_PA[0] != NULL)
         {
            ...
            ArrayResize(PA_Values,PATotal);
            
            for(int i=1;i<=PATotal;i++)
               {
                   Read_PriceAction(gPriceActionCSV,i);
                   PA_Values[i-1] = StringToDouble(gHistory_PA[0]); 
                            
               }
            int ValueSize = ArraySize(PA_Values);
            if(ValueSize >= 2)
               {
                   ArraySort(PA_Values,WHOLE_ARRAY,0,MODE_DESCEND);
                   for(int ii=0;ii<ValueSize;ii++)
                      {
                          double Price_Before = PA_Values[ii];
                          double Price_Forward = PA_Values[ii+1];
                          double Differ = (Price_Before - Price_Forward)/_Point;
                                
                          if(Differ <= Zone)
                            {
                                ObjectCreate(ChartID(),"Priceaction_ZONE",OBJ_RECTANGLE,0,BarTime_Backward,Price_Before,BarTime_Forward,Price_Forward);
                                ObjectSetInteger(ChartID(),"Priceaction_ZONE",OBJPROP_COLOR,clrMaroon);
                                      
                                int PA_Index = Get_OrderIndex(gPriceActionCSV,"Data",9,Price_Before);
                                Record_PriceAction(gPriceActionCSV,"Modify",PA_Index,0);
                                PA_Index = Get_OrderIndex(gPriceActionCSV,"Data",9,Price_Forward);
                                Record_PriceAction(gPriceActionCSV,"Modify",PA_Index,0);
            ...
            if(Is_PA_Recorded(Filename, gDepthKomu) == False)
              {
                 if(Is_PriceAction_Repeated(Filename, gDepthKomu) == False) // There is no record in other PA records
                   {
                      Record_PriceAction(Filename,"Append",0,gDepthKomu);
                 ...
                 else
                   {
                      if(Is_PA_Recorded(gStrongPACSV,gDepthKomu) == False)
                        {
                            Record_PriceAction(gStrongPACSV,"Append",0,gDepthKomu);
                            gPADepthLine = gDepthKomu;
                        }
            ...
            if(Is_PA_Recorded(Filename,gPeakKomu) == False)
              {
                  if(Is_PriceAction_Repeated(Filename,gPeakKomu) == False)
                    {
                       Record_PriceAction(Filename,"Append",0,gPeakKomu);
                  ...
                  else
                    {
                       if(Is_PA_Recorded(gStrongPACSV,gPeakKomu) == False)
                         {
                            Record_PriceAction(gStrongPACSV,"Append",0,gPeakKomu);
                            gPAPeakLine = gPeakKomu;
                         }
             ...
             if(Divergence(0) <= 100)
               {
                     ...
                     Alert("Tenkensen/Kijunsen Exit form PriceAction -- Bulls In Control");
                     Comment(RightBarTime,Message);
               }
             else
               {
             ...
             if(Divergence(0) <= 100)
               {
                    ...
                    string Message ="\n" + " >  Status: PRICEACTION -- PriceAction Exit";
                    Alert("Tenkensen/Kijunsen Exit form PriceAction -- Bears In Control");
                    Comment(RightBarTime,Message);
               }
             else
               {
             ...
             if(is_PrevCandle_Touch_Resistance(2,"BULLISH",gActivePA) == False)
               {
                   ...
                   Alert("Price Action Breakeven -- Bullish Candle Broke PriceAction Resistance." ,"\r\n" ," But There is a probability of PullBack");
                   Comment(RightBarTime,Message);
               }
             else
               {
             ...
             if(is_PrevCandle_Touch_Resistance(2,"BEARISH",gActivePA) == False)
               {
                   ...
                   Alert("Price Action Breakeven -- Bearish Candle Broke PriceAction Resistance." ,"\r\n" ,"But There is a probability of PullBack");
                   Comment(RightBarTime,Message);
               }
             else
               {
                        ...
                        if((Break_Validation("BULLISH",gActivePA) == True))
                          {
                              ...
                              Alert("Price Action Breakeven -- Bulls In Control. " ,"\r\n" ," There is a probability of PullBack");
                              Comment(RightBarTime,Message);
                          }
                        else
                          {
                              ...
                              Alert("Price Action Breakeven --  Bullish Candle Validly Broke PriceAction Resistance. " ,"\r\n" ,"But Last Candle Touched the Resistance, There is a probability of PullBack");
                              Comment(RightBarTime,Message);
                          }
         ...
         if((gBearCandleBreak != 0)  && (gBreakTime != RightBarTime))
           {
                    ...
                    if((is_PrevCandle_Touch_Resistance(3,"BEARISH",gActivePA) == False))
                        ...
                        if(Break_Validation("BEARSIH",gActivePA) == True)
                          {
                              ...
                              Alert("Price Action Breakeven -- Bears In Control. " ,"\r\n" ," There is a probability of PullBack");
                              Comment(RightBarTime,Message);
                          }
                        else
                          {
                              ...
                              Alert("Price Action Breakeven -- Bearish Candle Validly Broke PriceAction Resistance. " ,"\r\n" ,"But Last Candle Touched the Resistance, There is a probability of PullBack");
                              Comment(RightBarTime,Message);
                          }
                          }
                    ...
                    else
                     {
                        ...
                        Alert("Price Action Breakeven -- Bearish Candle Validly Broke PA Resistance. " ,"\r\n" ,"But Former Candles Touched the Resistance, There is a probability of PullBack");
                        Comment(RightBarTime,Message);
                     }
